...
export default function DosenProposal() {
  ...
  return (
    <div className="p-4 sm:p-6">
      ...
      {loading ? (
        ...
        <>
          {/* Wrapper agar tabel bisa digeser di mobile */}
          <div className="overflow-x-auto">
            <table className="min-w-[900px] w-full table-auto border text-sm bg-white rounded shadow">
              ...
              <tbody>
                {currentData.map((p, idx) => (
                  <tr key={p.id} className="hover:bg-gray-50">
                    ...
                    <td className="border px-2 py-1">{p.nama_topik || "-"}</td>
